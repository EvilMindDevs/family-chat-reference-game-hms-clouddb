...
namespace HmsPlugin
{
    public class HMSCloudDBManager : HMSSingleton<HMSCloudDBManager>
    {
        ...
        public Action<CloudDBZoneSnapshot<ChatAppOT>> OnExecuteQuerySuccess { get; set; }
        ...
        public Action<CloudDBZoneSnapshot<ChatAppOT>> OnExecuteQueryUnsyncedSuccess { get; set; }
        public Action<HMSException> OnExecuteQueryUnsyncedFailed { get; set; }

        public Action<CloudDBZoneSnapshot<ChatAppOT>> OnCloudDBZoneSnapshot { get; set; }
        ...
        public void ExecuteUpsert(ChatAppOT obj)
        {
        ...
        public void ExecuteDelete(ChatAppOT obj)
        {
            if (mCloudDBZone == null)
            {
                Debug.Log($"[{TAG}]: CloudDBZone is null, try re-open it");
        ...
        public void ExecuteQuery(CloudDBZoneQuery query, CloudDBZoneQuery.CloudDBZoneQueryPolicy CloudDBZoneQueryPolicy)
        {
            ...
            mCloudDBZone.ExecuteQuery<ChatAppOT>(query, CloudDBZoneQueryPolicy)
        ...
        public void ExecuteQueryUnsynced(CloudDBZoneQuery query)
        {
            ...
            mCloudDBZone.ExecuteQueryUnsynced<ChatAppOT>(query)
                .AddOnSuccessListener(result =>
                {
        ...
        public void CloseSubscribeSnapshot()
        {
            mRegister.Remove();
        }
    }
